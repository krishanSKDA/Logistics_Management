        ...
        <div class="row content-row">
                ...
                <div class="contact-form">
                    ...
                    <form id="mainContact" action="sendemail.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input name="email" type="email" class="form-control" required="" placeholder="Enter valid email">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="subject"><i class="fas fa-tag"></i> Subject</label>
                                    <input name="subject" type="text" class="form-control" required="" placeholder="enter your subject">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="phone"><i class="fas fa-phone"></i> Phone Number</label>
                                    <input name="phone" type="text" class="form-control" placeholder="add personal number">
                                </div>
                            </div>
                        </div>
                        <div class="form-group text-area">
                            <label for="message"><i class="fas fa-comment"></i> Your Message</label>
                            <textarea name="message" class="form-control" rows="3" required="" placeholder=""></textarea>
                        </div>
            ...
            <div class="col-md-5">
                ...
                <div class="contact-map">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63297.000556258026!2d80.58750463510825!3d7.45833439343957!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae344d7d465445d%3A0xd6f70562e8850dbc!2sMatale!5e0!3m2!1sen!2slk!4v1717876534157!5m2!1sen!2slk" 
                ...
                <div class="contact-info">
                    ...
                    <address>
                        <p><i class="fas fa-map-marker-alt"></i> 384 Maple Circle<br>
                           ...
                           <i class="fas fa-envelope"></i> Email: Nineway@transport.com</p>
                    </address>
                </div><!-- /.contact-info -->
            </div><!-- /.col-md-4 -->
            <div class="col-md-4">
                <div class="contact-info">
                    ...
                    <address>
                        <p><i class="fas fa-map-marker-alt"></i> 789 Oak Street<br>
                           ...
                           <i class="fas fa-envelope"></i> Email: contact@logistics.com</p>
                    </address>
                </div><!-- /.contact-info -->
            </div><!-- /.col-md-4 -->
            <div class="col-md-4">
                <div class="contact-info">
                    ...
                    <address>
                        <p><i class="fas fa-map-marker-alt"></i> 123 Pine Avenue<br>
                           ...
                           <i class="fas fa-envelope"></i> Email: info@freight.com</p>
                    </address>
                </div><!-- /.contact-info -->
            </div><!-- /.col-md-4 -->
        </div>
